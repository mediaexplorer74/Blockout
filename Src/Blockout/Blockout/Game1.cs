...
namespace Blockout
{
    public class Game1 : GameBase
    {
        ...
        {
            return PredefinedLevels.GetPerfectSolutionMoves(
                (ChallangeBlock)challangeIndex, levelIndex);
        }
        ...
        {
            Block parentKeywords = this.parentKeywordsBlock;
            ...
            this.parentKeywordsBlock = ActivatorFactory.parentKeywords;
        ...
        label_27:
            switch (3)
            {
                case 0:
                    goto label_27;
                default:
                    break; // Added break to resolve CS8070
            }
        label_28:
            if (!flag)
                return;
        ...
        private Rectangle GetHandyCenteredDrawPos()
        {
        ...
        {
            this.parentKeywordsBlock = blueBlock;
