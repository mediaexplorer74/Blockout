...
// Type: Blockout.DirectoryContext
...
namespace Blockout
{
  internal sealed class DirectoryContext
  {
    internal static EnemyBigBase[] DisconnectProject(int _param0) => new EnemyBigBase[_param0];
  }
}
