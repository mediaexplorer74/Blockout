...
namespace Blockout
{
  internal sealed class QueueResolver
  {
    internal static void DisconnectProject(ref TaskAwaiter<bool> _param0)
    {
      _param0 = new TaskAwaiter<bool>();
    }
  }
}
