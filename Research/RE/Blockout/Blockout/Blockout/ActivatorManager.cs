...
// Type: Blockout.ActivatorManager
...
namespace Blockout
{
  internal sealed class ActivatorManager
  {
    internal static UIntPtr DisconnectProject(Achievement[] _param0) => (UIntPtr) _param0.Length;
  }
}
