...
namespace Blockout
{
  ...
  public class Achievement
  {
    ...
    private const int parentKeywords = 700;
    ...
    private const float parentKeywords = 0.0333333351f;
    ...
    private static Rectangle parentKeywords;
    private static Rectangle currentUri;
    private static Rectangle filterID;
    private static Rectangle parentCancel;
    private Func<bool>[] parentKeywords;
    ...
    public void LoadContent(AchievementProperties achievements)
    {
      ...
      this.parentKeywords = achievements.AchievedTest;
