      ...
      switch (3)
      {
        ...
        default:
          if (false)
          {
            ...
            RuntimeMethodHandle runtimeMethodHandle = __methodref (DatabaseLoader.\u002Ecctor);
          }
...
label_3:
        switch (5)
        {
          ...
          default:
            ...
            {
              // ISSUE: method reference
              RuntimeMethodHandle runtimeMethodHandle = __methodref (DatabaseLoader.DisconnectProject);
            }
