...
// Type: Blockout.ConnectionInvoker
...
namespace Blockout
{
  internal sealed class ConnectionInvoker
  {
    internal static RuntimeTypeHandle DisconnectProject() => __typeref (SwapChainBackgroundPanel);
  }
}
