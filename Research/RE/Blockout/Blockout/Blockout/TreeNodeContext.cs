...
namespace Blockout
{
  internal sealed class TreeNodeContext
  {
    internal static void DisconnectProject(ref TaskAwaiter _param0) => _param0 = new TaskAwaiter();
  }
}
