...
namespace Blockout
{
  internal sealed class DriveConverter
  {
    internal static Dictionary<string, object> DisconnectProject(object _param0)
    {
      return (Dictionary<string, object>) _param0;
    }
  }
}
