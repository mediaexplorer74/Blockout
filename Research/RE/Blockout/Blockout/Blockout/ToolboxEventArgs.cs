...
// Type: Blockout.ToolboxEventArgs
...
namespace Blockout
{
  internal sealed class ToolboxEventArgs
  {
    internal static UIntPtr DisconnectProject(GameScreen[] _param0) => (UIntPtr) _param0.Length;
  }
}
