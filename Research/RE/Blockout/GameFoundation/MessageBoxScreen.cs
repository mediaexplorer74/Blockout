        ...
        switch (7)
        {
          ...
          default:
            if (false)
            {
              ...
              RuntimeMethodHandle runtimeMethodHandle = __methodref (MessageBoxScreen.\u002Ector);
            }
        ...
        switch (5)
        {
          ...
          default:
            if (true)
              break;
            // ISSUE: method reference
            RuntimeMethodHandle runtimeMethodHandle = __methodref (MessageBoxScreen.LoadContent);
            break;
        }
      }
      else
